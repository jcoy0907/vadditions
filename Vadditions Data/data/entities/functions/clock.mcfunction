...
#animal floor food
execute as @e[nbt={InLove:0}] at @s run function entities:processes/animal_floor_food/run
#firey fire charges
execute as @e[type=minecraft:item,nbt={Item:{id:"minecraft:fire_charge"},OnGround:1b}] at @s unless entity @p[distance=..1.2] run function entities:effects/firey_fire_charges
