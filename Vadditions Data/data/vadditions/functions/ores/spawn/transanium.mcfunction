...
#set block
setblock ~ ~ ~ minecraft:spawner{RequiredPlayerRange:0s,SpawnData:{ArmorItems:[{},{},{},{id:"minecraft:command_block",tag:{CustomModelData:1},Count:1b}],Pose:{RightArm:[30.0d,0.0d,0.0d],LeftArm:[30.0d,0.0d,0.0d]},id:"minecraft:armor_stand"}}
