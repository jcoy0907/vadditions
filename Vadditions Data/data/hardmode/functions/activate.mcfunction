execute as @s at @s align xz positioned ~.5 ~ ~.5 run particle minecraft:block minecraft:crafting_table ~.5 ~ ~ .5 .5 .5 .5 100 force @a
execute as @s at @s align xz positioned ~.5 ~ ~.5 run particle minecraft:block minecraft:nether_portal ~.5 ~ ~ .5 .5 .5 .5 100 force @a
...
execute unless entity @s[type=minecraft:player] if entity @a[distance=...5,gamemode=!creative,gamemode=!spectator] as @s at @s align xz positioned ~.5 ~ ~.5 run function death:hardmode_activation