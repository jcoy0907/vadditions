...
execute if entity @e[type=minecraft:item,distance=..1,sort=nearest,limit=1,nbt={Item:{id:"minecraft:dropper",Count:1b}},nbt=!{Thrower:{}}] run setblock ~ ~ ~ minecraft:dropper{Items:[{id:"minecraft:redstone",Count:1b,Slot:0b}],CustomName:"{\"translate\":\"text.vadditions.customcrafter.drop_items\"}"}
