...
#particles
execute if entity @e[type=minecraft:item,nbt={Item:{tag:{pages:["no particle"]}},OnGround:1b},distance=...5] run function entities:processes/armour_stand_modifications/particles/remove
execute if entity @e[type=minecraft:item,nbt={Item:{tag:{pages:["flame"]}},OnGround:1b},distance=...5] run function entities:processes/armour_stand_modifications/particles/add_flame
execute if entity @e[type=minecraft:item,nbt={Item:{tag:{pages:["end rod"]}},OnGround:1b},distance=...5] run function entities:processes/armour_stand_modifications/particles/add_end_rod
execute if entity @e[type=minecraft:item,nbt={Item:{tag:{pages:["smoke"]}},OnGround:1b},distance=...5] run function entities:processes/armour_stand_modifications/particles/add_smoke
