...
#called by vadditions:modules/custom_crafting/uncrafter/create
...
#run deaths nearby
execute unless entity @s[type=minecraft:player] as @a[distance=..1,gamemode=!creative,gamemode=!spectator] run function vadditions:modules/death/hardmode_activation
