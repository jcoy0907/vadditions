...
particle minecraft:block minecraft:packed_ice ~4 ~1 ~ 0 1.5 0 0 30 force
particle minecraft:block minecraft:packed_ice ~-4 ~1 ~ 0 1.5 0 0 30 force
particle minecraft:block minecraft:packed_ice ~ ~1 ~4 0 1.5 0 0 30 force
particle minecraft:block minecraft:packed_ice ~ ~1 ~-4 0 1.5 0 0 30 force
...
scoreboard players set @e[type=minecraft:armor_stand,tag=VADS_FreezeStand,distance=..1] VADS_FreezeTimer 0