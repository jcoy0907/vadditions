...
execute at @e[nbt={Tags:["VADS_Entity","VADS_BasicCrafter"]},scores={VADS_SlotCount=9}] as @e[type=minecraft:item,nbt={Item:{id:"minecraft:crafting_table",Count:1b},OnGround:1b},distance=..1] at @s unless entity @e[tag=VADS_CustomCrafter,tag=!VADS_BasicCrafter,distance=..1] if block ~ ~-1 ~ minecraft:dropper[facing=up]{Items:[{id:"minecraft:diamond",Count:1b,Slot:0b},{id:"minecraft:iron_block",Count:1b,Slot:1b},{id:"minecraft:diamond",Count:1b,Slot:2b},{id:"minecraft:obsidian",Count:1b,Slot:3b},{id:"minecraft:iron_block",Count:1b,Slot:4b},{id:"minecraft:obsidian",Count:1b,Slot:5b},{id:"minecraft:diamond",Count:1b,Slot:6b},{id:"minecraft:iron_block",Count:1b,Slot:7b},{id:"minecraft:diamond",Count:1b,Slot:8b}]} align xz run function custom_crafting:advanced/create
