...
#nether check
execute if entity @s[type=minecraft:zombie_pigman,tag=VADS_ReplaceMob] run function mobs:spawn/biome/nether
#cave check
execute if entity @s[tag=VADS_ReplaceMob] at @s positioned ~ 0 ~ if entity @s[distance=..20] run function mobs:spawn/biome/deep_cave
execute if entity @s[tag=VADS_ReplaceMob] at @s positioned ~ 0 ~ if entity @s[distance=..60] run function mobs:spawn/biome/cave
#spruce forest check
execute store success score @s VADS_CheckBiome run clone ~-4 ~-2 ~-4 ~4 ~2 ~4 ~-4 ~-2 ~-4 filtered minecraft:spruce_log force
execute if entity @s[tag=VADS_ReplaceMob,scores={VADS_CheckBiome=1..}] run function mobs:spawn/biome/spruce
#oak forest check
execute store success score @s VADS_CheckBiome run clone ~-4 ~-2 ~-4 ~4 ~2 ~4 ~-4 ~-2 ~-4 filtered minecraft:oak_log force
execute if entity @s[tag=VADS_ReplaceMob,scores={VADS_CheckBiome=1}] run function mobs:spawn/biome/forest
#swamp check
execute store success score @s VADS_CheckBiome run clone ~-5 ~-2 ~-5 ~3 ~ ~3 ~-5 ~-5 ~-5 filtered minecraft:vine force
execute if entity @s[tag=VADS_ReplaceMob,scores={VADS_CheckBiome=1..}] run function mobs:spawn/biome/swamp
#snowy biome check
execute store success score @s VADS_CheckBiome run clone ~-1 ~-2 ~-1 ~1 ~ ~1 ~-1 ~-2 ~-1 filtered minecraft:snow force
execute if entity @s[tag=VADS_ReplaceMob,scores={VADS_CheckBiome=1..}] run function mobs:spawn/biome/snow
#desert/mesa check
execute store success score @s VADS_CheckBiome run clone ~-1 ~-3 ~-1 ~1 ~-2 ~1 ~-1 ~-3 ~-1 filtered minecraft:sand force
execute if entity @s[tag=VADS_ReplaceMob,scores={VADS_CheckBiome=1..}] run function mobs:spawn/biome/desert
execute store success score @s VADS_CheckBiome run clone ~-1 ~-3 ~-1 ~1 ~-2 ~1 ~-1 ~-3 ~-1 filtered minecraft:red_sand force
execute if entity @s[tag=VADS_ReplaceMob,scores={VADS_CheckBiome=1..}] run function mobs:spawn/biome/red_desert
#jungle check
execute store success score @s VADS_CheckBiome run clone ~-5 ~-2 ~-5 ~4 ~4 ~4 ~-5 ~-2 ~-5 filtered minecraft:jungle_log force
execute if entity @s[tag=VADS_ReplaceMob,scores={VADS_CheckBiome=1..}] run function mobs:spawn/biome/jungle

#if no success, assume plains
execute if entity @s[tag=VADS_ReplaceMob] run function mobs:spawn/biome/plains
