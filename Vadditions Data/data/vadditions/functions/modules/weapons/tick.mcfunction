...
execute at @e[tag=VADS_LightField.Particle] run function vadditions:modules/weapons/light_fields/particle
execute if score Overall VADS_Random matches 1..30 at @e[tag=VADS_LightField.Particle] run tag @e[type=!minecraft:player,type=!minecraft:item,type=!#vadditions:no_weapon_damage,tag=!VADS_Undead,tag=!VADS_Passive,distance=..10,sort=random,limit=2] add VADS_LightField.Damage.Normal
execute if score Overall VADS_Random matches 1..30 at @e[tag=VADS_LightField.Particle] run tag @e[type=!minecraft:player,type=!minecraft:item,type=!#vadditions:no_weapon_damage,tag=VADS_Undead,distance=..10,sort=random,limit=2] add VADS_LightField.Damage.Invert
...
execute as @e[tag=VADS_LightField.Damage] at @s run function vadditions:modules/weapons/light_fields/damage
...
execute as @e[type=minecraft:item,nbt={Item:{tag:{isItem:1b,VADS_Item:"vadditions:sticky_tnt"}},OnGround:1b}] run kill @s[type=!minecraft:player]
        #stick
execute as @e[type=minecraft:tnt,tag=VADS_StickyTNT] at @s run function vadditions:modules/entities/processes/sticky_tnt
...
scoreboard players set @a[scores={VADS_UseCOAS=1..,VADS_ItemCool=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{VADS_Weapon:"vadditions:cactuthorn",isWeapon:1b}}}] VADS_ItemCool 0
        #timeout explosion
execute as @e[tag=VADS_CactuthornEntity.Front,scores={VADS_WpnRngdTm=30..}] at @s run function vadditions:modules/weapons/explosions/cactuthorn
...
execute as @e[type=minecraft:player,gamemode=!spectator,nbt=!{ActiveEffects:[{Id:14b}]},nbt={SelectedItem:{tag:{isWeapon:1b,VADS_Weapon:"vadditions:cactuthorn"}}}] at @s run particle minecraft:block minecraft:cactus
        #trail
execute at @e[tag=VADS_CactuthornEntity.Front] run summon minecraft:area_effect_cloud ~ ~-.5 ~ {Tags:["VADS_Entity","VADS_CactuthornEntity.Follow","VADS_CactuthornEntity","VADS_WeaponEntity"],Invisible:1,Invulnerable:1,Small:1,NoGravity:1,Marker:1,CustomName:"{\"text\":\"CactuthornEntity.Follow\"}",Duration:30}
execute at @e[tag=VADS_CactuthornEntity.Follow] run particle minecraft:enchanted_hit ~ ~1 ~ 0.001 0.001 0.001 .1 1 normal
        #damage
execute at @e[tag=VADS_CactuthornEntity.Follow] run effect give @e[type=!minecraft:player,type=!#vadditions:no_weapon_damage,tag=!VADS_Undead,tag=!VADS_UndeadButImmune,distance=..1] minecraft:instant_damage 1 0
execute at @e[tag=VADS_CactuthornEntity.Follow] run effect give @e[type=!minecraft:player,type=!#vadditions:no_weapon_damage,tag=VADS_Undead,tag=!VADS_UndeadButImmune,distance=..1] minecraft:instant_health 1 0
execute at @e[tag=VADS_CactuthornEntity.Follow] as @e[type=!minecraft:player,type=!#vadditions:no_weapon_damage,tag=!VADS_Undead,tag=VADS_UndeadButImmune,distance=..1] run data merge entity @s {Motion:[0.0d,2.0d,0.0d]}
execute at @e[tag=VADS_CactuthornEntity.Front] if entity @e[type=!minecraft:player,type=!#vadditions:no_weapon_damage,tag=!VADS_WeaponEntity,distance=..1] run playsound minecraft:entity.phantom.bite hostile @a ~ ~ ~
#hellstone
        #summon
...
execute as @a[scores={VADS_UseCOAS=1..,VADS_ItemCool=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{VADS_Weapon:"vadditions:hellstone",isWeapon:1b}}}] at @s run summon minecraft:armor_stand ~ ~1 ~ {Tags:["VADS_Entity","VADS_HellstoneEntity.Front","VADS_HellstoneEntity","VADS_WeaponEntity","VADS_FireStand"],NoGravity:1,CustomName:"{\"text\":\"HellstoneEntity.Front\"}",Marker:1,Small:1,Invisible:1}
...
execute as @a[scores={VADS_UseCOAS=1..,VADS_ItemCool=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{VADS_Weapon:"vadditions:hellstone",isWeapon:1b}}}] run scoreboard players set @s VADS_ItemCool 0
        #timeout explosion
execute as @e[tag=VADS_HellstoneEntity.Front,scores={VADS_WpnRngdTm=90..}] at @s run function vadditions:modules/weapons/explosions/hellstone
...
execute as @e[type=minecraft:player,gamemode=!spectator,nbt=!{ActiveEffects:[{Id:14b}]},nbt={SelectedItem:{tag:{isWeapon:1b,VADS_Weapon:"vadditions:hellstone"}}}] at @s run particle minecraft:flame
        #trail
execute at @e[tag=VADS_HellstoneEntity.Front] run summon minecraft:area_effect_cloud ~ ~-.5 ~ {Tags:["VADS_Entity","VADS_HellstoneEntity.Follow","VADS_HellstoneEntity","VADS_WeaponEntity"],Invisible:1,Invulnerable:1,Small:1,NoGravity:1,Marker:1,CustomName:"{\"text\":\"HellstoneEntity.Follow\"}",Duration:90}
...
execute at @e[tag=VADS_HellstoneEntity.Follow,scores={VADS_Age=..10}] run particle minecraft:flame ~ ~1 ~ 0 0 0 0 1 normal @a
        #damage
execute at @e[tag=VADS_HellstoneEntity.Follow] run effect give @e[type=!minecraft:player,type=!#vadditions:no_weapon_damage,tag=!VADS_Undead,tag=!VADS_UndeadButImmune,distance=..1] minecraft:instant_damage 1 0
execute at @e[tag=VADS_HellstoneEntity.Follow] run effect give @e[type=!minecraft:player,type=!#vadditions:no_weapon_damage,tag=VADS_Undead,tag=!VADS_UndeadButImmune,distance=..1] minecraft:instant_health 1 0
execute at @e[tag=VADS_HellstoneEntity.Follow] as @e[type=!minecraft:player,type=!#vadditions:no_weapon_damage,tag=!VADS_Undead,tag=VADS_UndeadButImmune,distance=..1] run data merge entity @s {Motion:[0.0d,2.0d,0.0d]}
execute at @e[tag=VADS_HellstoneEntity.Front] if entity @e[type=!minecraft:player,type=!#vadditions:no_weapon_damage,tag=!VADS_WeaponEntity,distance=..1] run playsound minecraft:entity.ender_dragon.hurt hostile @a ~ ~ ~
execute at @e[tag=VADS_HellstoneEntity] as @e[type=!minecraft:player,type=!#vadditions:no_weapon_damage,tag=!VADS_WeaponEntity,distance=..1] run data merge entity @s {Fire:100s}
    #ihd
        #summon
...
scoreboard players set @a[scores={VADS_UseCOAS=1..,VADS_ItemCool=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{VADS_Weapon:"vadditions:ihd",isWeapon:1b}}}] VADS_ItemCool 0
        #timeout explosion
execute as @e[tag=VADS_IHDEntity,scores={VADS_WpnRngdTm=600..}] at @s run function vadditions:modules/weapons/explosions/ihd
execute as @e[tag=VADS_IHDEntity,scores={VADS_WpnRngdTm=600..}] run kill @s[type=!minecraft:player]
        #teleportation
execute as @e[tag=VADS_IHDEntity.Front,scores={VADS_WpnRngdTm=0..59}] at @s facing entity @e[type=!minecraft:player,sort=nearest,limit=1,distance=..20,type=!#vadditions:no_weapon_damage,tag=!VADS_Undead,nbt=!{Health:1.0f}] feet run teleport @s ^ ^ ^1 ~ ~
execute as @e[tag=VADS_IHDEntity.Front,scores={VADS_WpnRngdTm=60..119}] at @s facing entity @e[type=!minecraft:player,sort=nearest,limit=1,distance=..20,type=!#vadditions:no_weapon_damage,tag=!VADS_Undead,nbt=!{Health:1.0f}] feet run teleport @s ^ ^ ^.5 ~ ~
execute as @e[tag=VADS_IHDEntity.Front,scores={VADS_WpnRngdTm=120..}] at @s facing entity @e[type=!minecraft:player,sort=nearest,limit=1,distance=..20,type=!#vadditions:no_weapon_damage,tag=!VADS_Undead,nbt=!{Health:1.0f}] feet run teleport @s ^ ^ ^.2 ~ ~
        #visuals
...
execute as @e[type=minecraft:player,gamemode=!spectator,nbt=!{ActiveEffects:[{Id:14b}]},nbt={SelectedItem:{tag:{isWeapon:1b,VADS_Weapon:"vadditions:ihd"}}}] at @s run particle minecraft:block minecraft:black_concrete
        #damage
execute at @e[type=minecraft:armor_stand,tag=VADS_IHDEntity.Front] if entity @e[type=!minecraft:player,type=!#vadditions:no_weapon_damage,tag=!VADS_WeaponEntity,distance=..1,nbt=!{Health:1.0f}] run playsound minecraft:entity.phantom.bite hostile @a ~ ~ ~
execute at @e[type=minecraft:armor_stand,tag=VADS_IHDEntity.Front] if entity @e[type=!minecraft:player,type=!#vadditions:no_weapon_damage,tag=!VADS_WeaponEntity,distance=..1,nbt=!{Health:1.0f}] run effect give @e[distance=..1,tag=!VADS_Undead,type=!#vadditions:no_weapon_damage] minecraft:poison 10 0

#loot tables
    #phantom
execute at @e[type=minecraft:armor_stand,tag=VADS_WeaponEntity] as @e[type=minecraft:phantom,tag=!VADS_Processed,distance=..1] run function vadditions:modules/weapons/loot_tables/add/entities/phantom/killed_by_weapon
