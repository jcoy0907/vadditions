...
execute align xyz run summon minecraft:armor_stand ~.5 ~.3 ~.5 {ArmorItems:[{},{},{},{id:"minecraft:command_block",Count:1b,tag:{CustomModelData:13}}],Tags:["VADS_Entity","VADS_NeedsOtherRandom","VADS_BonsaiPot","VADS_BonsaiPot.Filled_1"],NoGravity:1,Small:1,Marker:1,Invisible:1,CustomNameVisible:0,CustomName:"\"VADS_BonsaiPot\""}
