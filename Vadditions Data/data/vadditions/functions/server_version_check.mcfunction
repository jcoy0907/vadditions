...
#summon test entity
summon minecraft:armor_stand ~ ~ ~ {HandItems:[{id:"minecraft:trident",Count:1b,tag:{update:13}},{id:"minecraft:lectern",Count:1b,tag:{update:14}}],ArmorItems:[{id:"minecraft:stick",Count:1btag:{update:15}},{id:"minecraft:stick",Count:1btag:{update:16}},{id:"minecraft:stick",Count:1btag:{update:17}},{id:"minecraft:stick",Count:1btag:{update:18}}],Tags:["VADS_VersionTest"]}
#test hand items
