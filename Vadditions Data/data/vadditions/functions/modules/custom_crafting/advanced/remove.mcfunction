...
#replace items
execute if entity @e[type=minecraft:item,distance=..1,sort=nearest,limit=1,nbt={Item:{id:"minecraft:dropper",Count:1b}},nbt=!{Thrower:{}}] run loot spawn ~ ~ ~ loot vadditions:modules/custom_crafting/advanced/removal
#remove dropper name
