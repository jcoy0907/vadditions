...
execute if block ~1 ~ ~ minecraft:lever[powered=true] if block ~-1 ~ ~ minecraft:lever[powered=true] if block ~ ~ ~1 minecraft:lever[powered=true] if block ~ ~ ~-1 minecraft:lever[powered=true] run function machines:elevators/kill
...
execute if block ~ ~ ~ minecraft:air run function machines:elevators/kill
