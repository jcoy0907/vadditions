...
execute align xyz run summon minecraft:armor_stand ~.5 ~-.2 ~.5 {ArmorItems:[{},{},{},{id:"minecraft:command_block",Count:1b,tag:{CustomModelData:15}}],Tags:["VADS_Entity","VADS_FireStand","VADS_NeedsOtherRandom","VADS_SandExtractor"],NoGravity:1,Small:1,Marker:1,Invisible:1,CustomNameVisible:0,CustomName:"\"VADS_SandExtractor\""}
